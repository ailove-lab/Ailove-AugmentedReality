...
//-------------------------------------------------------------------------------------
bool BaseApplication::showConfigDialog (void)
...
bool BaseApplication::configure(void)
{
    ...
    if(showConfigDialog())
    {
        ...
        mWindow = mRoot->initialise(true, "GraphicsEngine Render Window");
...
void BaseApplication::createViewports(void)
{
    ...
    //Ogre::Viewport* vp2 = mWindow->addViewport(mCamera, 1, 0.75, 0.75, 0.25, 0.25);
